...
|------|---------|--------|--------------|
| **DELTA_NEUTRAL** | \|Funding rate\| > 0.001%/hr | Long spot (Jupiter) + short perp (Drift) | Funding payments |
...
- Allocation below `MIN_TRADE_SIZE` ($30) → **accumulated** into per-asset carryover
